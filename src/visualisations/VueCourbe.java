...
/**
 * Classe représentant une vue graphique d'une courbe.
 * <p>
 * Permet de visualiser des données booléennes ou flottantes sous forme de courbe.
 * Les coordonnées de la courbe sont automatiquement calculées et la fenêtre est
 * positionnée pour éviter le chevauchement avec d'autres vues.
 * </p>
 */
 public class VueCourbe  extends Vue {
	...
	/**
	 * Constructeur pour afficher une courbe à partir de valeurs booléennes.
	 * <p>
	 * Les valeurs true sont représentées par y=1 et false par y=0.
	 * La largeur de la fenêtre est proportionnelle au nombre de valeurs et au
	 * nombre de pixels par point.
	 * </p>
	 *
	 * @param valeurs tableau des valeurs booléennes à tracer
	 * @param nbPixels largeur en pixels d'un point sur la courbe
	...
	/**
	 * Constructeur pour afficher une courbe à partir de valeurs flottantes.
	 *
	 * @param valeurs tableau des valeurs float à tracer
	 * @param nom titre de la fenêtre
	 */
	...
	/**
	 * Met à jour la courbe avec de nouvelles valeurs booléennes.
	 *
	 * @param valeurs tableau des nouvelles valeurs booléennes
	 */
	...
	/**
	 * Met à jour la courbe avec de nouvelles valeurs flottantes.
	 *
	 * @param valeurs tableau des nouvelles valeurs float
	 */
	 ...
	 * Redessine la vue.
	 * <p>
	 * Cette méthode appelle la version de {@link #paint(Graphics)} en lui passant
	 * le contexte graphique courant obtenu via {@code getGraphics()}.
	 * </p>
	 */
    public void paint() {
	paint(getGraphics());
	...
	/**
	 * Dessine la courbe sur la fenêtre.
	 *
